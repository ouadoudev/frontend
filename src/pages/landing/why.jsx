...
export default function Why() {
  ...
  const reasons = [
    {
      ...
      content:
        "PrimeAcademy est conçu spécifiquement pour répondre aux besoins des élèves et enseignants du Maroc, du primaire au baccalauréat. Il est aligné avec le programme national et offre une expérience d'apprentissage interactive et enrichissante, parfaitement adaptée à la pédagogie marocaine.",
      icon: MapPin,
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content:
        "Avec PrimeAcademy, chaque élève bénéficie d'un suivi personnalisé. Les enseignants peuvent suivre l'évolution de chaque étudiant en temps réel, identifier les points faibles et proposer des solutions adaptées pour chaque individu.",
      icon: UserCheck,
    },
    {
      id: 4,
      ...
      content:
        "PrimeAcademy propose des interfaces en plusieurs langues, y compris l'arabe et le français, afin de s'adapter aux langues d'enseignement courantes dans le système éducatif marocain, garantissant ainsi une accessibilité maximale pour tous.",
      icon: Globe,
    },
    {
      id: 5,
      ...
      content:
        "En utilisant des outils interactifs tels que des quiz, des vidéos éducatives, des forums de discussion et des exercices pratiques, PrimeAcademy crée un environnement d'apprentissage stimulant, engageant et moderne. Les élèves peuvent apprendre à leur rythme, avec une richesse de ressources pédagogiques.",
      icon: PlayCircle,
    },
    {
      id: 6,
    ...
    },
    {
      ...
      content:
        "PrimeAcademy permet aux étudiants et enseignants d'accéder aux contenus à tout moment, offrant ainsi une flexibilité maximale pour étudier et enseigner à leur propre rythme, en dehors des heures scolaires traditionnelles.",
      icon: Clock,
    },
    {
      id: 9,
  ...
  return (
    <section id="features" className="relative py-16 md:py-16  overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50">
      <AnimatedBackground />
      <div className="container lg:w-2/3 mx-auto px-4">
        <motion.div
        ...
        <Card className=" px-4 md:px-2 rounded-lg shadow-xl w-full h-auto mx-auto">
          <CardContent className="pb-0">
            <div className="flex flex-col md:flex-row h-auto">
              ...
              >
                <ScrollArea className="h-[300px] md:h-[450px]  mt-4 md:mt-12">
                  {reasons.map((reason) => (
                    <ReasonItem
                      key={reason.id}
                      reason={reason}

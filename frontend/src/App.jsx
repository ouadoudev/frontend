...
import SuiviParEnfants from "./pages/Parent/Suivi";
import ParentRegister from "./pages/Parent/Register";
import Parents from "./components/dashboard/users/Parents";
import Planning from "./pages/Teacher/Planning";
import PlanningView from "./pages/Teacher/PlanningDetails";
import UnitPlanDetails from "./pages/Teacher/UnitPlanDetails";
import UnitPlans from "./pages/Teacher/UnitPlans";
import JoudadaPage from "./pages/Teacher/joudada";
import CreatePlanPage from "./components/dashboard/programme/CreatePlanPage";
import AddActivityPage from "./components/dashboard/programme/AddActivityPage";
import Jodadas from "./pages/Teacher/joudadas";
      ...
      <TestimonialManager>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/parent/suivi" element={<SuiviParEnfants />} />
            ...
            />
            <Route path="/planning/create" element={<CreatePlanPage />} />
            <Route path="/planning" element={<Planning />} />
            <Route path="/planning/:planId/add-activity" element={<AddActivityPage />} />
            <Route path="/planning/view/:id" element={<PlanningView />} />
            <Route path="/unit-plans" element={<UnitPlans />} />
            <Route
              path="/unit-plan/:annualPlanId/unit/:unitId"
              element={<UnitPlanDetails />}
            />
            <Route path="/joudadas" element={<Jodadas />} />
            <Route
              path="/joudada/:annualPlanId/session/:sessionId"
              element={<JoudadaPage />}
            />

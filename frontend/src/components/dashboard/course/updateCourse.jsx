...
//   const convertToCommaSeparatedString = (enhancedItems) => {
...
//   useEffect(() => {
//     const levels = [...new Set(subjects.map((subject) => subject.educationalLevel))]
...
//                   <p className="mt-1 text-sm text-gray-600">Drag and drop your image here, or click to select</p>
//                   <input
//                     id="file-upload"
//                     name="file-upload"
//                     type="file"
...
//                     accept="image/*"
//                   />
//                   <Button type="button" onClick={() => document.getElementById("file-upload").click()} className="mt-2">

          ...
          <div className="space-y-4">
                  ...
                  <div key={index} className="flex items-center space-x-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        // Pas besoin de changer correctAnswers ici, car l'index reste le même
                        updateQuestion(question.id, { options: newOptions });
                      }}
                    ...
                    {question.options.length > 2 && (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          if (newCorrectAnswers.includes(index.toString())) {
                            // Si on supprime la bonne réponse, on la retire des réponses correctes
                            newCorrectAnswers = newCorrectAnswers.filter(
                              (ans) => ans !== index.toString(),
                            );
                          } else {
                            // Si on supprime une option placée AVANT la bonne réponse,
                            // il faut réduire l'index de la bonne réponse de 1 pour qu'il corresponde toujours
                            newCorrectAnswers = newCorrectAnswers.map((ans) => {
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  // On sauvegarde bien l'index sous forme de tableau de string ["0"]
              ...
              >
                ...
                <SelectContent>
                  {question.options?.map((option, index) => {
                    // Ne montrer dans le menu déroulant que les options remplies

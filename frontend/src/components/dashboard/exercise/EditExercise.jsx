...
const EditExercise = () => {
    ...
    (step) => {
      ...
      if (step === 1) {
        ...
        if (exercise.totalPoints <= 0 || exercise.totalPoints > 5) {
          errors.totalPoints = "Les points totaux doivent être compris entre 1 et 5";
        }
        if (exercise.maxAttempts <= 0 || exercise.maxAttempts > 10) {
          errors.maxAttempts = "Le nombre maximum de tentatives doit être compris entre 1 et 10";
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormErrors({
        submit: error.message || "Échec de la mise à jour de l'exercice. Veuillez réessayer.",
      });
    } finally {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-lg text-gray-600">Chargement des données de l'exercice...</div>
        </div>
      </div>
    );
  }
        ...
        <Card className="max-w-md">
          <CardContent className="py-8">
            <div className="text-center text-red-600">
              ...
              <p className="mb-4">Erreur lors du chargement de l'exercice : {error}</p>
              ...
              <div className="flex items-center justify-between">
                ...
                <Select onValueChange={(value) => addQuestion(value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="drag-and-drop">Glisser-Déposer</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </CardHeader>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <CardTitle className="text-2xl font-bold text-gray-900">
                      Modifier l'exercice : {exercise.title || "Chargement..."}
                    </CardTitle>
                  </div>
                  <Badge
                    variant="secondary"

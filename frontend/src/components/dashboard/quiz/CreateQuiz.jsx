...
//   const { currentQuiz, loading, error, successMessage } = useSelector((state) => state.quiz)
...
//       const quizData = Array.isArray(currentQuiz) ? currentQuiz[0] : currentQuiz
...
//                 errors[`correctAnswer_${index}`] = "Correct answer must be 'True' or 'False'"
//               }
//             } else {
...
//                 errors[`correctAnswer_${index}`] = "Correct answer must match one of the options"
//               }
//             }
//           })
//         }
...
//       const errorKey = field === "questionText" ? `question_${index}` : `${field}_${index}`
...
//         setFormErrors((prev) => ({ ...prev, [`options_${qIndex}`]: undefined }))
//       }
//     },
//     [formData.questions, formErrors],
//   )
...
//     (questionIndex, file) => {
//       const newQuestions = [...formData.questions]
//       newQuestions[questionIndex].attachment = file ? URL.createObjectURL(file) : null
//       setFormData((prev) => ({ ...prev, questions: newQuestions }))
//     },
//     [formData.questions],
//   )
...
//   const memoizedQuestions = useMemo(() => formData.questions, [formData.questions])
...
//                 </div>
//                 <div className="space-y-2">
//                   <Label htmlFor="timeLimit" className="flex items-center space-x-1">
...
//                     onChange={(e) => handleInputChange("timeLimit", Number.parseInt(e.target.value, 10) || 0)}
//                     className={formErrors.timeLimit ? "border-red-500" : ""}
//                     min="1"
//                     placeholder="10"
//                   />
//                   {formErrors.timeLimit && <p className="text-red-500 text-sm">{formErrors.timeLimit}</p>}
//                 </div>
//               </div>
//               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//                 <div className="space-y-2">
//                   <Label htmlFor="passingScore" className="flex items-center space-x-1">
...
//                     onChange={(e) => handleInputChange("passingScore", Number.parseInt(e.target.value, 10) || 0)}
//                     className={formErrors.passingScore ? "border-red-500" : ""}
//                     min="1"
//                     max="100"
//                     placeholder="75"
//                   />
//                   {formErrors.passingScore && <p className="text-red-500 text-sm">{formErrors.passingScore}</p>}
//                 </div>
//               </div>
//               <div className="space-y-2">
...
//                 </CardTitle>
//                 <Button type="button" onClick={addQuestion} size="sm" className="bg-blue-600 hover:bg-blue-700">
...
//                               className={`${snapshot.isDragging ? "shadow-lg" : ""} border-l-4 border-l-blue-500`}
//                             >
...
//                                     onValueChange={(value) => handleQuestionChange(qIndex, "questionType", value)}
//                                   >
//                                     <SelectTrigger>
//                                       <SelectValue />
//                                     </SelectTrigger>
...
//                                     className={formErrors[`question_${qIndex}`] ? "border-red-500" : ""}
//                                     placeholder="Enter your question"
//                                     rows={2}
//                                   />
//                                   {formErrors[`question_${qIndex}`] && (
//                                     <p className="text-red-500 text-sm">{formErrors[`question_${qIndex}`]}</p>
//                                   )}
//                                 </div>
//                                 {/* Question Attachment */}
//                                 <div className="space-y-2">
...
//                                       <p className="text-red-500 text-sm">{formErrors[`options_${qIndex}`]}</p>
//                                     )}
//                                   </div>
//                                 )}
//                                 {/* Correct Answer */}
...
//                                   >
//                                     <SelectTrigger
//                                       className={formErrors[`correctAnswer_${qIndex}`] ? "border-red-500" : ""}
//                                     >
//                                       <SelectValue placeholder="Select correct answer" />
//                                     </SelectTrigger>
//                                     <SelectContent>
//                                       {question.options
//                                         .filter((opt) => opt.trim() || question.questionType === "true-false")
//                                         .map((option, optIndex) => (
...
//                                     <p className="text-red-500 text-sm">{formErrors[`correctAnswer_${qIndex}`]}</p>
//                                   )}
//                                 </div>
//                               </CardContent>
//                             </Card>
...
//                             option === question.correctAnswer ? "bg-green-100 text-green-800 font-medium" : "bg-gray-50"
//                           }`}
//                         >
//                           {question.questionType !== "true-false" && (
...
//                           )}
//                           {option}
//                           {option === question.correctAnswer && <CheckCircle className="inline h-4 w-4 ml-2" />}
//                         </div>
//                       ))}
//                     </div>
//                   </div>
...
//                       ? `Update Existing Quiz: ${formData.title || "Loading..."}`
//                       : "Create New Quiz"}
//                   </CardTitle>
...
//                           </div>
//                         </button>
//                         {index < STEPS.length - 1 && <ChevronRight className="h-4 w-4 text-gray-400 mx-2" />}
//                       </div>
//                     )
//                   })}
//                 </div>
...
//               <AlertDescription className="text-green-800">{formErrors.success}</AlertDescription>
//             </Alert>
//           )}

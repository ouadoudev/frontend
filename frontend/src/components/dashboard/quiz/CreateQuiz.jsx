                                        ...
                                        (option, optIndex) => (
                                          ...
                                          >
                                            ...
                                            <Input
                                              ...
                                              placeholder={`Option ${
                                                optIndex + 1
                                              } (utilisez $...$ pour les formules)`}
                                              className="flex-1"
                                            />
                                            {/* Aperçu KaTeX pour l'option */}
                                            {option && (
                                              <div className="w-32 p-1 bg-gray-50 rounded border text-xs">
                      ...
                      {question.options.map((option, optIndex) => (
                        <div
                          ...
                          className={`text-sm p-3 rounded border ${
                            option === question.correctAnswer
                              ? "bg-green-100 text-green-800 font-medium border-green-200"
                              : "bg-gray-50"
                          }`}
                        >
                          <div className="flex items-center space-x-2">
                            <span className="font-mono min-w-[1rem]">
                              {String.fromCharCode(65 + optIndex)}.
                            </span>

            ...
            <Card className="mb-6 bg-transparent border-none">
              <CardHeader>
                ...
                <div className="flex flex-wrap  gap-4 mb-6">
                  ...
                  >
                    <SelectTrigger className="w-[350px] px-10">
              ...
              <CardContent>
                {filteredSubjects?.map((subject) => (
                  <Accordion
                    ...
                    key={subject._id}
                  >
                    <AccordionItem value={`item-${subject._id}`}>
                      <AccordionTrigger>
                        <div
                      ...
                      <AccordionContent>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-2 line-clamp-2 "dir={getDirection(subject.title)}>
                          {subject.description}
                        </p>
